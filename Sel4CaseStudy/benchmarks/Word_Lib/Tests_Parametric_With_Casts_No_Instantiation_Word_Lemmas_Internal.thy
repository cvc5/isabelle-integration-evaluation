...
theory Tests_Parametric_With_Casts_No_Instantiation_Word_Lemmas_Internal
...
(* NOTE: this lemma is not included since it depends on a lemma whose proof
         uses instantiation *)
...
(* NOTE: this lemma is not included since it depends on a lemma whose
         proof uses instantiation *)
...
(* NOTE: this lemma will be used to prove sint_ucast_uint *)
...
(* NOTE: required to prove from_to_bool_le_1_idem *)
lemma word_le_1:
  fixes w :: "'a::len word"
...
(* NOTE: this lemma is required to prove scast_ucast_up_minus_1_ucast *)
lemma msb_le_mono:
...
(* NOTE: this lemma is used to prove word_upcast_0_sle*)
...
(* NOTE: lemma required to prove ucast_increment *)
...
(* NOTE: lemma required to prove shiftr_less_max_mask *)
