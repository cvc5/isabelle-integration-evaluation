...
theory Tests_Parametric_No_Casts_No_Instantiation_Word_Lemmas_Internal
...
(* NOTE: this lemma is commented out since it depends on a lemma that has casting *)
...
(* NOTE: this lemma depends on unat_minus', which contains casts *)
...
(* TODO: should we consider mask as a kind of coercion? *)
...
(* NOTE: lemma required to prove another lemma, below *)
...
(* NOTE: lemma commented out since it depends on a non-pure bv lemma *)
...
(* NOTE: required for word_shiftr_less_mono *)
