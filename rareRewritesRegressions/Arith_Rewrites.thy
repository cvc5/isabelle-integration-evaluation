...
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-int-div-total.smt2"
...
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-int-mod-total.smt2"
...
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-elim-gt.smt2"
  "./Benchmarks/Arith_Rewrites/arith-elim-gt.alethe"

(*(define-rule arith-elim-lt ((t ?) (s ?)) (< t s) (not (>= t s)))*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-elim-lt.smt2"
...
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-elim-leq.smt2"
...
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-geq-norm1-real.smt2"
  "./Benchmarks/Arith_Rewrites/arith-geq-norm1-real.alethe"


(*(define-rule arith-eq-elim-real ((t Real) (s Real)) (= t s) (and (>= t s) (<= t s)))*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-eq-elim-real.smt2"
  "./Benchmarks/Arith_Rewrites/arith-eq-elim-real.alethe"
...
(*(define-cond-rule arith-int-geq-tighten ((t Int) (c Real) (cc Int))
  ...
  (>= t cc))*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-int-geq-tighten.smt2"
  "./Benchmarks/Arith_Rewrites/arith-int-geq-tighten.alethe"
...
(*(define-rule arith-geq-ite-lift ((C Bool) (t ?) (s ?) (r ?))
  ...
  (ite C (>= t r) (>= s r)))*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-geq-ite-lift.smt2"
...
(*(define-rule arith-min-lt1 ((t ?) (s ?))
  ...
  true)*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-min-lt1.smt2"
  "./Benchmarks/Arith_Rewrites/arith-min-lt1.alethe"
...
(*(define-rule arith-min-lt2 ((t ?) (s ?))
  ...
  true)*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-min-lt2.smt2"
  "./Benchmarks/Arith_Rewrites/arith-min-lt2.alethe"
...
(*(define-rule arith-max-geq2 ((t ?) (s ?))
  ...
  true)*)
check_smt ("cvc5_proof")
  "./Benchmarks/Arith_Rewrites/arith-max-geq2.smt2"
  "./Benchmarks/Arith_Rewrites/arith-max-geq2.alethe"
