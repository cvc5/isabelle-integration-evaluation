...
config=$2
class="QF_UF"
declare -a dir_names=("20170829-Rodin" "2018-Goel-hwbench" "20190906-CLEARSY" "eq_diamond" "NEQ" "PEQ" "QG-classification/qg7" "QG-classification/qg5" "QG-classification/qg6" "QG-classification/loops6" "SEQ" "TypeSafe")
...
do
  ...
  /barrett/scratch/local/bin/submit-job.sh  -b $dir_name -d out/$dir_name --full-access-dir /barrett/scratch/lachnitt/Binaries/IsabelleSetUp/.isabelle/ -o $current/$new_bench_dir ../scripts/checkOneBench.sh
