...
check_smt_dir_stats "~/Sources/IsabelleEvaluation/RewriteReconstruction/GeneratedProblems/" "~/Sources/IsabelleEvaluation/RewriteReconstruction/Results/ResultsWithoutRewrites.txt"
